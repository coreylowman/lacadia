...
void inputs_update_mouse(Inputs *i, GLFWwindow *w, int button, int action,
                         int mods) {
...
void inputs_update_mouse_position(Inputs *i, GLFWwindow *w, double x,
                                  double y) {
...
void inputs_update_keys(Inputs *i, GLFWwindow *window, int key, int scancode,
                        int action, int mod) {
...
void inputs_update_scroll(Inputs *i, GLFWwindow *w, double xoffset,
                          double yoffset) {
