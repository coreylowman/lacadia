...
void mat4_ident(Mat4 *mat) { *mat = MAT4_IDENT; }

void mat4_mul(Mat4 *dest, Mat4 mat1, Mat4 mat2) {
  float a00 = mat1.data[0], a01 = mat1.data[1], a02 = mat1.data[2],
        a03 = mat1.data[3], a10 = mat1.data[4], a11 = mat1.data[5],
        a12 = mat1.data[6], a13 = mat1.data[7], a20 = mat1.data[8],
        a21 = mat1.data[9], a22 = mat1.data[10], a23 = mat1.data[11],
        a30 = mat1.data[12], a31 = mat1.data[13], a32 = mat1.data[14],
        a33 = mat1.data[15],

        b00 = mat2.data[0], b01 = mat2.data[1], b02 = mat2.data[2],
        b03 = mat2.data[3], b10 = mat2.data[4], b11 = mat2.data[5],
        b12 = mat2.data[6], b13 = mat2.data[7], b20 = mat2.data[8],
        b21 = mat2.data[9], b22 = mat2.data[10], b23 = mat2.data[11],
        b30 = mat2.data[12], b31 = mat2.data[13], b32 = mat2.data[14],
        b33 = mat2.data[15];
...
void mat4_rotate(Mat4 *mat, float rads, Vec3 axis) {
  double x = axis.x, y = axis.y, z = axis.z, len = sqrt(x * x + y * y + z * z),
...
float mat4_mul_vec3(Vec3 *out_vec, Mat4 mat, Vec3 vec) {
  ...
  out_vec->x =
      mat.data[0] * x + mat.data[1] * y + mat.data[2] * z + mat.data[3];
  out_vec->y =
      mat.data[4] * x + mat.data[5] * y + mat.data[6] * z + mat.data[7];
  out_vec->z =
      mat.data[8] * x + mat.data[9] * y + mat.data[10] * z + mat.data[11];
