...
void renderable_component_render(RenderableComponent self, Renderer *renderer);
void renderable_component_update(RenderableComponent *self, double dt);
...
RenderableComponent renderable_component_init(GameObject *container, const char *model_name, Renderer *renderer) {
    ...
    self.base_component = component_init(container, renderable_component_update, renderable_component_render);
